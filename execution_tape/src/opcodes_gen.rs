...
/// Flat operand role table indexed by `OperandLayout`.
pub const OPERAND_ROLES: &[OperandRole] = &[
    OperandRole::Dst,
    OperandRole::Src,
    OperandRole::TrapCode,
    OperandRole::Dst,
    OperandRole::Dst,
    OperandRole::Imm,
    OperandRole::Dst,
    ...
    OperandRole::Dst,
    OperandRole::St,
    OperandRole::FieldIndex,
    OperandRole::Dst,
    OperandRole::ElemType,
    OperandRole::Values,
    OperandRole::Dst,
    OperandRole::Arr,
    OperandRole::Dst,
...
impl Opcode {
    ...
    #[must_use]
    pub fn operand_roles(self) -> &'static [OperandRole] {
        let layout = self.info().operands;
        let start = usize::from(layout.start);
        let end = start + usize::from(layout.len);
        &OPERAND_ROLES[start..end]
    }
}
